(() => {
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/arrow-right.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/chevron-down.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/database.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/globe.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/languages.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/refresh-cw.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/shield-alert.js
  ...
  // ../../src/client-edge/node_modules/lucide-react/dist/esm/icons/trending-up.js
  var TrendingUp = createLucideIcon("TrendingUp", [
    ["polyline", { points: "22 7 13.5 15.5 8.5 10.5 2 17", key: "126l90" }],
    ["polyline", { points: "16 7 22 7 22 13", key: "kwv8wd" }]
  ]);

  // ../../src/client-edge/src/app/prediction/components/types.ts
  var getCleanPercentage = (val) => {
  ...
  var Header = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "rounded-3xl border border-slate-800 bg-slate-950/90 p-6 md:p-8 shadow-[0_24px_60px_rgba(0,0,0,0.35)] relative overflow-hidden", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "absolute top-0 right-0 w-80 h-80 bg-[#00f2fe]/5 rounded-full filter blur-[80px] pointer-events-none" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col gap-5 md:flex-row md:items-center md:justify-between relative z-10", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { href: "/", className: "p-2 rounded-xl bg-slate-900 border border-slate-800 hover:border-[#00f2fe] text-slate-400 hover:text-white transition-all", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ArrowLeft, { size: 14 }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "text-[#00f2fe] text-xs uppercase tracking-[0.35em] font-mono flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Cpu, { size: 12 }),
              " KOL_DECISION_BOARD"
            ] })
          ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-wrap items-center gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-2 bg-slate-900/60 p-1.5 rounded-2xl border border-slate-800", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-slate-500 font-mono pl-2", children: "\u76D1\u63A7\u76EE\u6807:" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "select",
                {
                  ...
                  children: kols.map((kol) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: kol.id, children: kol.name }, kol.id))
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronDown, { size: 14, className: "absolute right-3.5 top-2.5 text-slate-500 pointer-events-none" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-2 bg-slate-900/60 p-1.5 rounded-2xl border border-slate-800", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-xs text-slate-500 font-mono pl-2", children: "\u65F6\u5E8F\u7A97\u53E3:" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative", children: [
          ...
          hasReport && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center gap-2 bg-slate-900/60 p-1.5 rounded-2xl border border-slate-800", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              ...
              title: "\u5237\u65B0\u7F13\u5B58\u6570\u636E",
              children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RefreshCw, { size: 14, className: loading ? "animate-spin text-[#00f2fe]" : "" })
            }
          )
        ] })
      ] })
  ...
  var AnalysisCharts = ({ hotTopics, industries }) => {
    const renderDonutChart = (data) => {
      const total = data.reduce((acc, curr) => acc + curr.value, 0);
      const radius = 50;
      const circumference = 2 * Math.PI * radius;
      let accumulatedOffset = 0;
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-8 py-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative w-40 h-40", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { className: "w-full h-full transform -rotate-90", viewBox: "0 0 120 120", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[10px] text-slate-500 tracking-wider font-mono", children: "SECTOR" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-sm font-black text-white mt-0.5", children: "\u884C\u4E1A\u5360\u6BD4" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex flex-col gap-2.5", children: data.map((ind, i) => {
          const color = CHART_COLORS[i % CHART_COLORS.length];
          return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-3 text-xs", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `w-3 h-3 rounded-full ${color.bg} border ${color.stroke.replace("stroke", "border")} shrink-0` }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-slate-400 font-medium", children: ind.name }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `font-mono font-bold ml-auto ${color.text}`, children: [
              ind.value,
              "%"
            ] })
          ] }, i);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "rounded-3xl border border-slate-800 bg-slate-900/40 p-6 md:p-8 space-y-6 shadow-md relative overflow-hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute top-0 right-0 w-40 h-40 bg-indigo-500/5 rounded-full filter blur-[50px] pointer-events-none" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("h3", { className: "text-base font-extrabold text-white flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TrendingUp, { size: 16, className: "text-[#00f2fe]" }),
          "\u63A8\u6587\u70ED\u95E8\u8BDD\u9898\u70ED\u5EA6\u6392\u884C (Hot Topics)"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "space-y-4", children: hotTopics.map((topic, i) => {
          const color = CHART_COLORS[i % CHART_COLORS.length];
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between text-xs", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-semibold text-slate-200", children: topic.topic }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-slate-500 font-mono", children: [
                topic.count,
                "\u6B21\u63D0\u53CA (",
                displayPct,
                "%)"
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-full h-2 rounded-full bg-slate-900 border border-slate-800/80 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "div",
              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "rounded-3xl border border-slate-800 bg-slate-900/40 p-6 md:p-8 space-y-6 shadow-md relative overflow-hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute top-0 right-0 w-40 h-40 bg-emerald-500/5 rounded-full filter blur-[50px] pointer-events-none" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("h3", { className: "text-base font-extrabold text-white flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PieChart, { size: 16, className: "text-emerald-400" }),
  ...
  var ChainAnalysis = ({ bottlenecks, valueChain }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      ...
      hasValueChain && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "rounded-3xl border border-slate-800 bg-slate-900/40 p-6 md:p-8 space-y-6 shadow-md", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("h3", { className: "text-base font-extrabold text-white flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Database, { size: 16, className: "text-[#00f2fe]" }),
          "\u4EA7\u4E1A\u94FE\u8282\u70B9\u56FE\u8C31\u6620\u5C04 (Value Chain Nodes)"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "space-y-4", children: valueChain.map((node, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "rounded-2xl border border-slate-800 bg-slate-955/40 p-4 space-y-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "text-[10px] font-mono text-slate-500", children: [
            "\u6620\u5C04\u8DEF\u5F84 #",
            i + 1
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-col gap-0.5 bg-slate-900/80 px-3 py-2 rounded-xl border border-slate-800 min-w-[120px] max-w-[180px] cursor-help", title: node.upstream, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-[9px] font-mono text-slate-500", children: "\u4E0A\u6E38\u7EC4\u4EF6 (Upstream)" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-xs font-bold text-white truncate", children: node.upstream })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ArrowRight, { className: "text-slate-650 hidden sm:block shrink-0", size: 12 }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-col gap-0.5 bg-slate-900/80 px-3 py-2 rounded-xl border border-slate-800 min-w-[120px] max-w-[180px] cursor-help", title: node.midstream, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-[9px] font-mono text-slate-500", children: "\u4E2D\u6E38\u7CFB\u7EDF (Midstream)" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-xs font-bold text-[#00f2fe] truncate", children: node.midstream })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ArrowRight, { className: "text-slate-650 hidden sm:block shrink-0", size: 12 }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-col gap-0.5 bg-slate-900/80 px-3 py-2 rounded-xl border border-slate-800 min-w-[120px] max-w-[180px] cursor-help", title: node.downstream, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-[9px] font-mono text-slate-500", children: "\u4E0B\u6E38\u5BA2\u6237 (Downstream)" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-xs font-bold text-emerald-400 truncate", children: node.downstream })
            ] })
          ] })
        ] }, i)) })
      ] })
  ...
  var TweetTimeline = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "space-y-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "rounded-3xl border border-slate-800 bg-slate-900/30 p-5 flex flex-wrap items-center justify-between gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Calendar, { className: "text-[#00f2fe]", size: 20 }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h4", { className: "font-bold text-white text-sm", children: "\u4E2D\u82F1\u5BF9\u7167\u63A8\u6587\u5217\u8868" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "text-xs text-slate-400 mt-0.5", children: [
              "\u6570\u636E\u6E90\u66F4\u65B0\u65F6\u95F4: ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "font-mono text-slate-300", children: lastUpdated })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-2 text-xs font-mono text-slate-500 bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-800", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Database, { size: 12, className: "text-[#00f2fe]" }),
          " \u672C\u5730\u7F13\u5B58\u6587\u4EF6: report_translated_",
          selectedKolId,
          ".json"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "space-y-8", children: filteredTweets.length > 0 ? filteredTweets.map((dayGroup, idx) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "space-y-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "w-2 h-4 bg-[#00f2fe] rounded-full" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { className: "text-lg font-extrabold text-white font-mono", children: dayGroup.date }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "text-xs text-slate-500 bg-slate-900 border border-slate-800 px-2 py-0.5 rounded-md", children: [
            "\u5171 ",
            dayGroup.tweets.length,
            " \u6761\u5185\u5BB9"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "space-y-4", children: dayGroup.tweets.map((tweet, tIdx) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "space-y-2 border-r border-slate-800/0 lg:border-r lg:border-slate-800/80 pr-0 lg:pr-6", children: [
      ...
      ] }, idx)) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-center py-12 text-slate-500 border border-slate-900 bg-slate-950/40 rounded-3xl", children: "\u5F53\u524D\u65F6\u5E8F\u7A97\u53E3\u8303\u56F4\u5185\u6682\u65E0\u5DF2\u7FFB\u8BD1\u7684\u63A8\u6587\u6570\u636E\u3002" }) })
    ] });
  };
  ...
  function PredictionApp() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("main", { className: "min-h-screen bg-slate-950 text-slate-100 font-sans p-4 md:p-10", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "max-w-7xl mx-auto space-y-6", children: [
      ...
      loading && !report && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "rounded-3xl border border-slate-800 bg-slate-900/20 p-20 text-center space-y-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(RefreshCw, { size: 28, className: "animate-spin text-[#00f2fe] mx-auto" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-slate-500", children: "\u6B63\u5728\u8F7D\u5165\u6700\u65B0\u6570\u636E\u5BF9\u7167\u8D26\u672C..." })
      ] }),
      error && !loading && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "rounded-3xl border border-rose-500/20 bg-rose-500/5 p-6 text-center text-rose-450 text-xs", children: error }),
      report ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          AnalysisCharts,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Watchlist, { watchlist: report.conviction_watchlist }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          ChainAnalysis,
          {
      ...
      ] }) : !loading && !error && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "rounded-3xl border border-dashed border-slate-800 bg-slate-900/10 p-12 text-center text-slate-500 space-y-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Terminal, { size: 48, className: "mx-auto text-slate-700 animate-pulse" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "max-w-md mx-auto space-y-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h4", { className: "font-bold text-slate-400", children: "\u6570\u636E\u5BF9\u7167\u7F13\u5B58\u6587\u4EF6\u672A\u627E\u5230" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-slate-500 leading-relaxed", children: "\u8BF7\u5148\u5728\u4ED3\u5E93\u5185\u8FD0\u884C\u6570\u636E\u66F4\u65B0\u811A\u672C\u751F\u6210\u62A5\u544A\uFF0C\u5E76\u628A JSON \u62F7\u5165\u672C\u9875 kol/ \u76EE\u5F55\u3002" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "inline-block rounded-2xl bg-slate-955 p-4 border border-slate-800/60 font-mono text-[10px] text-left text-slate-400 space-y-1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[#00f2fe]", children: "# 1. \u8FDB\u5165\u540E\u7AEF\u9879\u76EE" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "cd src/cloud-orchestrator" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[#00f2fe]", children: "# 2. \u6FC0\u6D3B\u865A\u62DF\u73AF\u5883" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "source .venv/bin/activate" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[#00f2fe]", children: "# 3. \u8FD0\u884C\u7FFB\u9875\u91C7\u96C6\u5E76\u8BA9 AI \u7FFB\u8BD1\u4E0E\u5F52\u7EB3" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "python run_analysis.py" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[#00f2fe]", children: "# 4. \u91CD\u65B0\u6253\u5305\uFF08\u81EA\u52A8\u540C\u6B65\u62A5\u544A\u5230 kol/\uFF09" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "cd standalone && make prediction" })
        ] })
      ] })
    ] }) });
  }
  ...
  if (rootEl) {
    (0, import_client.createRoot)(rootEl).render(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(PredictionApp, {}));
  }
})();
