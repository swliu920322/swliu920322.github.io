...
!(function() {
  ...
  !(function(a, b) {
    ...
    function u(a, b, c) {
      ...
      const f = q(c.duration, d, c.iterations, e, c.iterationStart),
    ...
    (function() {
      if (document.documentElement.animate) {
        let c = document.documentElement.animate([], 0),
          d = !0;
        if (
          (c &&
            ((d = !1),
      ...
      !(function(a, b, c) {
        ...
        b.convertEffectInput = function(c) {
          const f = a.normalizeKeyframes(c),
            g = d(f),
            h = e(g);
          return function(a, c) {
            if (null != c)
        ...
        (function(a, b) {
          ...
          for (const l in document.documentElement.style)
            l in h ||
              l in i ||
              (function(a) {
                d(e.prototype, a, {
        ...
        (function(a) {
          function b(b) {
            function c(b) {
              let c = a.consumeToken(/^inset/i, b);
              return c
                ? ((d.inset = !0), c)
        ...
        (function(a, b) {
          ...
          const g = "px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc",
          ...
          (a.parseLength = h),
            ...
            (a.parseAngle = j),
            (a.mergeDimensions = f);
          const k = a.consumeParenthesised.bind(null, h),
        ...
        (function(a, b) {
            ...
            return null == d[0] || null == e[0]
              ...
              : (d[0].push(0),
                ...
                [
                  ...
                  e,
                  function(b) {
                    const c = a.quat(d[0][3], e[0][3], b[5]);
                    return a
          ...
          function j(b, c) {
            let d = a.makeMatrixDecomposition && !0,
              e = !1;
          ...
          a.addPropertiesHandler(e, j, ["transform"]),
            (a.transformToSvgMatrix = function(b) {
              const c = a.transformListToMatrix(e(b));
              return (
                "matrix(" +
                f(c[0]) +
                " " +
    ...
    (function(a) {
      let b = document.documentElement,
        ...
        d = !1;
      try {
        const e = getComputedStyle(b).getPropertyValue("opacity"),
          f = "0" == e ? "1" : "0";
